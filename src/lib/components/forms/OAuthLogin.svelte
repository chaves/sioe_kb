<script lang="ts">
  ...
  import { Github, Facebook, Twitter } from "lucide-svelte";
...
<div class="grid gap-4 my-3">
  <form class="grid gap-2" method="POST">
    ...
    >
      <Twitter name="twitter" class="w-4 h-4 mr-2" />
    ...
    >
      <Facebook name="facebook" class="w-4 h-4 mr-2" />
    ...
    >
      <Github name="github" class="w-4 h-4 mr-2" />
      Sign in with Github
    </button>
  </form>
</div>
